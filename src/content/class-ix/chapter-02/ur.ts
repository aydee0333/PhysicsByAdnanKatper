      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'مندرجہ ذیل میں سے کون سی ویکٹر مقدار ہے؟', options: ['رفتار', 'فاصلہ', 'سمت رفتار', 'وقت'], correctIndex: 2, explanation: 'سمت رفتار میں مقدار اور سمت دونوں ہوتے ہیں جو اسے ویکٹر مقدار بناتی ہے۔' },
            { id: 'q2', question: 'گاڑی 100 میٹر مشرق چلتی ہے پھر 50 میٹر مغرب۔ جابائی کیا ہے؟', options: ['150 میٹر', '50 میٹر مشرق', '50 میٹر مغرب', '100 میٹر'], correctIndex: 1, explanation: 'جابائی = 100 - 50 = 50 میٹر مشرق (شروع سے آخر تک سب سے چھوٹا راستہ)۔' },
            { id: 'q3', question: 'اگر گاڑی سکون سے 2 m/s² کی شرح سے 5 سیکنڈ تک تیز ہو تو اس کی آخری رفتار ہے:', options: ['10 m/s', '5 m/s', '2.5 m/s', '7 m/s'], correctIndex: 0, explanation: 'v = u + at = 0 + 2×5 = 10 m/s۔' },
            { id: 'q4', question: 'رفتار-وقت گراف کے تحت کا رقبہ ظاہر کرتا ہے:', options: ['اسراع', 'رفتار', 'جابائی', 'قوت'], correctIndex: 2, explanation: 'v-t گراف کے تحت = جابائی۔' },
            { id: 'q5', question: 'مستقل رفتار سے دائرے میں حرکت کرنے والی چیز میں:', options: ['صفر اسراع', 'مستقل سمت رفتار', 'بدلنے والی سمت رفتار', 'کوئی قوت نہیں'], correctIndex: 2, explanation: 'سمت مسلسل بدلتی ہے، اس لیے سمت رفتار (ویکٹر) بدلتی ہے چاہے رفتار مستقل ہو۔' },
          ],
        },
      ],
    },
