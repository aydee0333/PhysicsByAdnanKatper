      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'هوڪ جو قانون ٻڌائي ٿو ته:', options: ['F = ma', 'F = kx', 'P = F/A', 'E = mc²'], correctIndex: 1 },
            { id: 'q2', question: 'دبائو جي ايس آئي ايڪو آهي:', options: ['نيوٽن (N)', 'پاسڪل (Pa)', 'جول (J)', 'واٽ (W)'], correctIndex: 1 },
            { id: 'q3', question: 'ڪنھن شيء تيرندي آهي جڏو اُن جي گهڻڪ هجي:', options: ['سيال جي گهڻڪ کان وڌيڪ', 'سيال جي گهڻڪ کان گهٽ', 'سيال جي گهڻڪ جي برابر', 'صفر'], correctIndex: 1 },
            { id: 'q4', question: 'يانگ جو مائڊيولس ناپي ٿو:', options: ['گهڻڪ', 'دبائو', 'مادي جي سختي', 'حرارت'], correctIndex: 2 },
            { id: 'q5', question: 'سطح بحر تي ماحولي دبائو تقريباً آهي:', options: ['101,325 Pa', '10,000 Pa', '1,000,000 Pa', '1,000 Pa'], correctIndex: 0 },
          ],
        },
      ],
    },
