      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'ہوک کا قانون بیان کرتا ہے کہ:', options: ['F = ma', 'F = kx', 'P = F/A', 'E = mc²'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q2', question: 'دباؤ کی ایس آئی اکائی ہے:', options: ['نیوٹن (N)', 'پاسکل (Pa)', 'جول (J)', 'واٹ (W)'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q3', question: 'کوئی چیز تیرتی ہے جب اس کی کثافت ہو:', options: ['سیال کی کثافت سے زیادہ', 'سیال کی کثافت سے کم', 'سیال کی کثافت کے برابر', 'صفر'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q4', question: 'یانگ کا ماؤڈیولس ناپتا ہے:', options: ['کثافت', 'دباؤ', 'مادے کی سختی', 'درجہ حرارت'], correctIndex: 2, type: 'mcq',
              explanation: '',
},
            { id: 'q5', question: 'سطح بحر پر ماحولیاتی دباؤ تقریباً ہے:', options: ['101,325 Pa', '10,000 Pa', '1,000,000 Pa', '1,000 Pa'], correctIndex: 0, type: 'mcq',
              explanation: '',
},
          ],
        },
