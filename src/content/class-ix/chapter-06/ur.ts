...
const chapter06Ur: ChapterContent = {
  ...
  objectives: [
    'نیوٹن کا عالمگیر کشش کا قانون بیان کریں اور اس کی ریاضیاتی شکل F = GMm/r² لکھیں',
    'کششی میدان کی طاقت کی وضاحت کریں اور بیان کریں کہ g اونچائی اور گہرائی کے ساتھ کیسے بدلتا ہے',
    'g = GM/R² استعمال کرتے ہوئے زمین کا ماسہ حساب لگائیں',
    'مداری حرکت کی وضاحت کریں اور مداری رفتار کا فارمولا v = √(GM/r) حاصل کریں',
    'کمیت اور وزن میں فرق بتائیں؛ زمین اور چاند پر فرق بیان کریں',
    'بے وزنی اور مصنوعی سیٹلائٹ کے تصور کی وضاحت کریں',
  ],
  sections: [
    {
      id: 'newtons-law',
      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'کششی قوت:', options: ['ہمیشہ کششی', 'ہمیشہ دافعہ', 'کبھی کبھی کششی', 'خلاء میں صفر'], correctIndex: 0, type: 'mcq',
              explanation: '',
},
            { id: 'q2', question: 'زمین پر g = 9.8 m/s² ہے۔ چاند پر g ≈:', options: ['9.8 m/s²', '1.6 m/s²', '0 m/s²', '24.8 m/s²'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q3', question: '200 km اونچائی پر مداری رفتار تقریباً ہے:', options: ['3 km/s', '7.8 km/s', '11.2 km/s', '15 km/s'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q4', question: 'زمین کے مرکز میں g =', options: ['9.8 m/s²', '4.9 m/s²', '0 m/s²', '19.6 m/s²'], correctIndex: 2, type: 'mcq',
              explanation: '',
},
            { id: 'q5', question: 'خلابان بے وزنی محسوس کرتے ہیں کیونکہ:', options: ['خلاء میں کوئی کشش نہیں', 'وہ آزاد سقوط میں ہیں', 'اسپیس اسٹیشن بہت بھاری ہے', 'وہ خاص لباس پہنتے ہیں'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
          ],
        },
