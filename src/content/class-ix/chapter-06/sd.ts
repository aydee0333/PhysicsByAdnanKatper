      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'ڪششي قوت:', options: ['هميشه ڪششي', 'هميشه دافعه', 'ڪڀي ڪڀي ڪششي', 'خلاء ۾ صفر'], correctIndex: 0 },
            { id: 'q2', question: 'زمين تي g = 9.8 m/s² آهي. چانڊ تي g ≈:', options: ['9.8 m/s²', '1.6 m/s²', '0 m/s²', '24.8 m/s²'], correctIndex: 1 },
            { id: 'q3', question: '200 km اوچائي تي مداري رفتار تقريباً آهي:', options: ['3 km/s', '7.8 km/s', '11.2 km/s', '15 km/s'], correctIndex: 1 },
            { id: 'q4', question: 'زمين جي مرڪز ۾ g =', options: ['9.8 m/s²', '4.9 m/s²', '0 m/s²', '19.6 m/s²'], correctIndex: 2 },
            { id: 'q5', question: 'خلابان بي وزني محسوس ڪن ٿا ڇوڪه:', options: ['خلاء ۾ ڪوئي ڪشش ناهي', 'اهي آزاد سقوط ۾ هون ٿا', 'اسپيس اسٽيشن تمام ڳنڍو آهي', 'اهي خاص لباس پاهنديا'], correctIndex: 1 },
          ],
        },
      ],
    },
