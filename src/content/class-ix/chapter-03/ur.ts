      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'نیوٹن کا پہلا قانون کس نام سے بھی جانا جاتا ہے؟', options: ['قانونِ اسراع', 'قانونِ جمود', 'قانونِ عمل و ردِعمل', 'قانونِ کشش ثقل'], correctIndex: 1, explanation: 'نیوٹن کا پہلا قانون قانونِ جمود کہلاتا ہے کیونکہ یہ بیان کرتا ہے کہ چیزیں اپنی حرکت میں تبدیلی کا مزاحمت کرتی ہیں۔' },
            { id: 'q2', question: 'اگر F = 20 N اور m = 4 kg ہو تو اسراع کیا ہوگا؟', options: ['80 m/s²', '5 m/s²', '24 m/s²', '16 m/s²'], correctIndex: 1, explanation: 'a = F/m = 20/4 = 5 m/s²۔' },
            { id: 'q3', question: 'جب آپ دیوار کو دھکا دیتے ہیں تو دیوار واپس دھکا دیتا ہے:', options: ['زیادہ قوت سے', 'کم قوت سے', 'برابر اور مخالف قوت سے', 'کوئی قوت نہیں'], correctIndex: 2, explanation: 'نیوٹن کے تیسرے قانون کے مطابق دیوار برابر اور مخالف قوت سے واپس دھکا دیتی ہے۔' },
            { id: 'q4', question: 'مومینٹم کی ایس آئی اکائی ہے:', options: ['نیوٹن (N)', 'kg·m/s', 'm/s²', 'جول (J)'], correctIndex: 1, explanation: 'مومینٹم = کمیت × سمت رفتار، اس لیے اکائی = kg × m/s = kg·m/s۔' },
            { id: 'q5', question: 'مرکزی قوت ہمیشہ کس سمت میں ہوتی ہے؟', options: ['مرکز سے دور', 'مرکز کی طرف', 'دائرے کی مماسی طرف', 'اوپر کی طرف'], correctIndex: 1, explanation: 'مرکزی کا مطلب ہے "مرکز طلب" — یہ ہمیشہ دائرے کے مرکز کی طرف ہوتی ہے۔' },
          ],
        },
      ],
    },
