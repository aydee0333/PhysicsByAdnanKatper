      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'توانائی کی ایس آئی اکائی ہے:', options: ['واٹ (W)', 'جول (J)', 'نیوٹن (N)', 'پاسکل (Pa)'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q2', question: '2 kg کا جسم 3 m/s سے چل رہا ہے۔ اس کی حرکی توانائی ہے:', options: ['6 J', '9 J', '18 J', '12 J'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q3', question: 'توانائی کا تحفظ مطلب ہے:', options: ['توانائی بنائی جا سکتی ہے', 'توانائی ختم ہو سکتی ہے', 'توانائی تبدیل ہوتی ہے لیکن کل مستقل رہتی ہے', 'توانائی ہمیشہ بڑھتی ہے'], correctIndex: 2, type: 'mcq',
              explanation: '',
},
            { id: 'q4', question: 'طاقت کی پیمائش ہوتی ہے:', options: ['جول میں', 'نیوٹن میں', 'واٹ میں', 'پاسکل میں'], correctIndex: 2, type: 'mcq',
              explanation: '',
},
            { id: 'q5', question: '40% کارکردگی والا انجن:', options: ['ان پٹ کا 40% مفید کام میں تبدیل کرتا ہے', '40% ایندھن استعمال کرتا ہے', '40% طاقت کا نقصان ہوتا ہے', '40% زیادہ توانائی پیدا کرتا ہے'], correctIndex: 0, type: 'mcq',
              explanation: '',
},
          ],
        },
