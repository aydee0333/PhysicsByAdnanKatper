      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'ڪن حالت ۾ ذرات紧密 packed هوندا؟', options: ['گيس', 'مايع', 'ٺوس', 'پلازما'], correctIndex: 2 },
            { id: 'q2', question: 'سيال جو دبائو منحصر آهي:', options: ['ٻرت جي شڪل تي', 'ڏرائي، گهڻڪ ۽ g تي', 'سيال جي حجم تي', 'صرف حرارت تي'], correctIndex: 1 },
            { id: 'q3', question: 'پاسڪل جو قانون استعمال ٿي ٿو:', options: ['ٿرماميٽر ۾', 'هائيڊرولڪ پريس ۾', 'بيروميٽر ۾', 'سپيڊوميٽر ۾'], correctIndex: 1 },
            { id: 'q4', question: 'سطحي ڪشش ڪن کان پيدا ٿي ٿي؟', options: ['ڪشش ثقل کان', 'cohesive قوتن کان', 'مقناطيسي قوتن کان', 'برقي رو کان'], correctIndex: 1 },
            { id: 'q5', question: 'ڪن ۾ تمام وڌيڪ وسڪوسيٽي آهي؟', options: ['پاڻي', 'تيل', 'شاهدو', 'الڪحل'], correctIndex: 2 },
          ],
        },
      ],
    },
