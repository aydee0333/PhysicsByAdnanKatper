...
const chapter07Ur: ChapterContent = {
  ...
  objectives: [
    'حرکیاتی مالیکیولر ماڈل کی مدد سے مادے کی تین حالتیں بیان کریں',
    'آرکیمیڈز کے اصول کی وضاحت کریں اور توانائی سے متعلق مسائل حل کریں',
    'پاسکل کا قانون بیان کریں اور ہائیڈرولک نظاموں میں اس کے استعمال کی وضاحت کریں',
    'وسکوسٹی کی وضاحت کریں اور اسے متاثر کرنے والے عوامل بیان کریں',
    'سطحی کشیدگی اور سیال رویے پر اس کے اثرات کی وضاحت کریں',
    'P = ρgh استعمال کرتے ہوئے سیالوں میں دباؤ سے متعلق مسائل حل کریں',
  ],
  sections: [
    {
      ...
      blocks: [
        {
          type: 'quiz',
          questions: [
            { id: 'q1', question: 'کس حالت میں ذرات紧密 packed ہوتے ہیں؟', options: ['گیس', 'مائع', 'ٹھوس', 'پلازما'], correctIndex: 2, type: 'mcq',
              explanation: '',
},
            { id: 'q2', question: 'سیال کا دباؤ منحصر ہے:', options: ['برتن کی شکل پر', 'گہرائی، کثافت اور g پر', 'سیال کے حجم پر', 'صرف درجہ حرارت پر'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q3', question: 'پاسکل کا قانون استعمال ہوتا ہے:', options: ['تھرمامیٹر میں', 'ہائیڈرولک پریس میں', 'بیرومیٹر میں', 'سپیڈومیٹر میں'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q4', question: 'سطحی کشیدگی کس سے پیدا ہوتی ہے؟', options: ['کشش ثقل سے', 'cohesive قوتوں سے', 'مقناطیسی قوتوں سے', 'برقی رو سے'], correctIndex: 1, type: 'mcq',
              explanation: '',
},
            { id: 'q5', question: 'کس میں سب سے زیادہ وسکوسٹی ہے؟', options: ['پانی', 'تیل', 'شہد', 'الکحل'], correctIndex: 2, type: 'mcq',
              explanation: '',
},
          ],
        },
