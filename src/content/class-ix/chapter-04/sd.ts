...
const chapter04Sd: ChapterContent = {
  ...
  objectives: [
    'ٽارڪ (قوت جو مومنٽ) جي تعريف ڏيو ۽ اهو قوت ۽ عمودي فاصلي تي ڪيئن منحصر آهي',
    'مومنٽن جو اصول بيان ڪريو ۽ مسئلا حل ڪريو',
    'ڪپل جي تعريف ڏيو ۽ ڪپل جو ٽارڪ ڳڻيو',
    'سخت جسم جي توازن جا ٽي شرط بيان ڪريو',
    'باقاعده ۽ بي قاعده شين جي ثقل جو مرڪز ڳڻيو',
    'مستحڪم، غير مستحڪم ۽ بي طرفه توازن ۾ فرق ڪريو',
  ],
  sections: [
    {
      id: 'torque',
