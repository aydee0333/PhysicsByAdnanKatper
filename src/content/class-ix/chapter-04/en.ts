...
const chapter04En: ChapterContent = {
  ...
  objectives: [
    'Define torque (moment of a force) and explain how it depends on force and perpendicular distance',
    'State and explain the principle of moments and apply it to solve problems',
    'Define a couple and calculate the torque produced by a couple',
    'Explain the two conditions of equilibrium for a rigid body',
    'Determine the centre of gravity of regular and irregular objects',
    'Distinguish between stable, unstable, and neutral equilibrium with examples',
  ],
  sections: [
    {
      id: 'torque',
          ...
          questions: [
            {
              ...
              correctIndex: 1,
              explanation: 'Torque or moment of a force is the turning effect produced by a force about a pivot point.',
            },
            {
              id: 'q2',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'Using τ = F × d = 10 N × 2 m = 20 Nm.',
            },
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              correctIndex: 2,
              explanation: 'A body is in equilibrium when both the net force (ΣF = 0) and net torque (Στ = 0) are zero.',
            },
            {
              id: 'q4',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'A couple is formed by two equal and opposite forces whose lines of action do not coincide, producing rotation without translation.',
            },
            {
              id: 'q5',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'For a uniform rod, the centre of gravity is at its geometric centre (middle point).',
            },
            {
              id: 'slo1',
              type: 'mcq',
              question: 'The principle of moments states that for a body in equilibrium:',
              options: ['All forces are equal', 'Sum of clockwise moments equals sum of anticlockwise moments', 'Net force is not zero', 'Torque is maximum'],
              correctIndex: 1,
            ...
            },
            {
              id: 'slo2',
              type: 'mcq',
              question: 'A steering wheel is turned by applying two equal and opposite forces on opposite sides. This is an example of:',
              options: ['Like forces', 'Unlike forces', 'A couple', 'Equilibrium'],
              correctIndex: 2,
              explanation: 'A couple consists of two equal and opposite forces whose lines of action do not coincide, producing pure rotation. Turning a steering wheel with both hands is a classic example.',
            },
          ],
        },
      ],
