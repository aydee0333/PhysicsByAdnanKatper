...
const chapter05En: ChapterContent = {
  ...
  objectives: [
    ...
    'State Ohm\'s law and apply it to solve circuit problems',
    'Define resistance and explain the factors affecting it',
    'Analyze series and parallel circuits and calculate total resistance',
    'Define electrical power and energy, and solve problems using P = VI',
    'Explain the function of safety devices (fuse, circuit breaker, earthing)',
  ],
  sections: [
    {
      id: 'electric-current',
      ...
      blocks: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              correctIndex: 1,
              explanation: 'Ohm\'s law states that V = IR, where V is potential difference, I is current, and R is resistance.',
            },
            {
              id: 'q3',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'In a series circuit, the same current flows through all components because there is only one path for current.',
            },
            {
              id: 'q4',
              type: 'mcq',
              ...
              correctIndex: 3,
              explanation: 'Resistance R = ρl/A depends on length (l), cross-sectional area (A), resistivity (ρ, which depends on material), and temperature.',
            },
            {
              id: 'q5',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'A fuse wire must have a low melting point so it melts quickly when excess current flows, breaking the circuit and protecting appliances.',
            },
            {
              id: 'q6',
              type: 'mcq',
              ...
              options: ['2R', 'R', 'R/2', '4R'],
              correctIndex: 2,
              explanation: 'For two equal resistors in parallel: 1/R_total = 1/R + 1/R = 2/R, so R_total = R/2.',
            },
            {
              id: 'q7',
              type: 'mcq',
            ...
            },
            {
              ...
              correctIndex: 1,
              explanation: 'An ammeter measures current and must be connected in series so all the current flows through it.',
            },
            {
              id: 'q9',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'Using Ohm\'s law: I = V/R = 5/10 = 0.5 A.',
            },
            {
              id: 'q10',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'Earthing provides a low-resistance path for current to flow to the ground, preventing electric shock if a live wire touches the appliance body.',
            },
            {
              id: 'slo1',
              type: 'mcq',
              question: 'Three resistors of 3Ω, 6Ω, and 6Ω are connected in parallel. The total resistance is:',
              options: ['15Ω', '1.5Ω', '2Ω', '5Ω'],
              correctIndex: 1,
              explanation: '1/R = 1/3 + 1/6 + 1/6 = 2/6 + 1/6 + 1/6 = 4/6 = 2/3. R = 3/2 = 1.5Ω.',
            },
            {
              id: 'slo2',
              type: 'mcq',
              question: 'A 60W bulb is used for 5 hours. The energy consumed is:',
              options: ['300 kWh', '0.3 kWh', '30 kWh', '0.03 kWh'],
              correctIndex: 1,
              explanation: 'E = Pt = 60W × 5h = 300 Wh = 0.3 kWh.',
            },
          ],
        },
      ],
