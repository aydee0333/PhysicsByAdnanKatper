...
const chapter02En: ChapterContent = {
  ...
  objectives: [
    'Describe how sound is produced by vibrating bodies and propagated through a medium',
    'Explain that sound requires a material medium and cannot travel through vacuum',
    'State the factors affecting the speed of sound in different media',
    'Define and distinguish between pitch, loudness, and quality of sound',
    'Explain echo, reverberation, and their practical applications',
    'Describe ultrasound and its uses in medicine, industry, and navigation',
  ],
  sections: [
    {
      id: 'sound-production',
          ...
          questions: [
            {
              ...
              correctIndex: 3,
              explanation: 'Sound needs a material medium to travel. In vacuum there are no particles to vibrate, so sound cannot propagate.',
            },
            {
              id: 'q2',
              type: 'mcq',
              ...
              options: ['Air', 'Water', 'Steel', 'Vacuum'],
              correctIndex: 2,
              explanation: 'Sound travels fastest in solids because particles are closely packed. Speed in steel ≈ 5960 m/s, much faster than in air (343 m/s) or water (1480 m/s).',
            },
            {
              id: 'q3',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'Frequency is measured in hertz (Hz), named after Heinrich Hertz. 1 Hz = 1 vibration per second.',
            },
            {
              id: 'q4',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'Loudness depends on the amplitude of the sound wave. Larger amplitude means louder sound. Loudness is measured in decibels (dB).',
            },
            {
              id: 'q5',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'Pitch depends on frequency. Higher frequency produces a higher-pitched (shriller) sound, while lower frequency produces a lower-pitched (graver) sound.',
            },
            {
              id: 'q6',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'Humans can hear sounds in the frequency range of 20 Hz to 20,000 Hz. Below 20 Hz is infrasound; above 20,000 Hz is ultrasound.',
            },
            {
              id: 'q7',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'SONAR (Sound Navigation and Ranging) uses the reflection of ultrasound waves to detect objects underwater and measure ocean depth.',
            },
            {
              id: 'q8',
              type: 'mcq',
            ...
            },
            {
              ...
              correctIndex: 1,
              explanation: 'Sound waves are longitudinal waves where particles vibrate parallel to the direction of propagation, creating compressions and rarefactions.',
            },
            {
              id: 'q10',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'Reverberation is the persistence of sound caused by multiple reflections from walls, ceiling, and other surfaces. Echo is a single distinct reflection.',
            },
            {
              id: 'slo1',
              type: 'mcq',
              question: 'A person shouts near a cliff and hears the echo after 0.5 seconds. If the speed of sound is 340 m/s, how far is the cliff?',
              options: ['85 m', '170 m', '340 m', '680 m'],
              correctIndex: 0,
              explanation: 'Using d = vt/2: d = (340 × 0.5)/2 = 170/2 = 85 m. The sound travels to the cliff and back, so we divide by 2.',
            },
            {
              id: 'slo2',
              type: 'mcq',
              question: 'Why do astronauts use radio waves to communicate in space?',
              options: ['Radio waves are louder than sound', 'Sound cannot travel through vacuum', 'Radio waves travel slower than sound', 'Sound travels too fast in space'],
              correctIndex: 1,
              explanation: 'Space is a vacuum with no particles to vibrate. Sound requires a material medium, so astronauts use radio waves (electromagnetic waves) which can travel through vacuum.',
            },
            {
              id: 'slo3',
              type: 'mcq',
              question: 'Which of the following is an application of ultrasound?',
              options: ['AM radio broadcasting', 'Medical sonography', 'X-ray imaging', 'Infrared remote control'],
              correctIndex: 1,
              explanation: 'Ultrasound (sound above 20 kHz) is used in medical sonography to create images of internal body organs, in SONAR for underwater detection, and in industrial cleaning.',
            },
          ],
        },
      ],
