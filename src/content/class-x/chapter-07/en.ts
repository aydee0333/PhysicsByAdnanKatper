...
const chapter07En: ChapterContent = {
  ...
  objectives: [
    'Explain energy bands in conductors, insulators, and semiconductors using band theory',
    'Describe p-type and n-type semiconductors and the doping process',
    'Explain the function of a p-n junction diode in forward and reverse bias',
    'Describe transistor action and differentiate between NPN and PNP types',
    'Explain the working of basic logic gates (AND, OR, NOT, NAND, NOR) and their truth tables',
    'Describe rectification and amplification using diodes and transistors',
  ],
  sections: [
    {
          ...
          questions: [
            {
              ...
              correctIndex: 1,
              explanation: 'Silicon (Si) is a semiconductor — its conductivity lies between conductors (copper, iron) and insulators (rubber).',
            },
            {
              id: 'q2',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'In n-type semiconductors, pentavalent impurities add extra free electrons, making electrons the majority charge carriers.',
            },
            {
              id: 'q3',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'A diode conducts only in forward bias (positive to p-side, negative to n-side), where the depletion region narrows and current flows.',
            },
            {
              id: 'q4',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'Rectification is the process of converting alternating current (AC) into direct current (DC) using diodes.',
            },
            {
              id: 'q5',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'A transistor has three terminals: emitter (E), base (B), and collector (C).',
            },
            {
              id: 'q6',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'Current gain β = Ic / Ib, where Ic is the collector current and Ib is the base current. It measures how much the transistor amplifies the base current.',
            },
            {
              id: 'q7',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'The OR gate outputs HIGH (1) when any input is HIGH. Its Boolean expression is Y = A + B.',
            },
            {
              id: 'q8',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'A NAND gate is AND followed by NOT. It gives LOW only when all inputs are HIGH (the AND condition is true, then NOT inverts it).',
            },
            {
              id: 'q9',
              type: 'mcq',
              ...
              correctIndex: 1,
              explanation: 'At the p-n junction, electrons from the n-side cross over and recombine with holes on the p-side, creating a region with no free charge carriers — the depletion region.',
            },
            {
              id: 'q10',
              type: 'mcq',
              ...
              correctIndex: 2,
              explanation: 'NOR gate = OR + NOT. It gives HIGH output only when all inputs are LOW.',
            },
            {
              id: 'slo1',
              type: 'mcq',
              question: 'In band theory, the energy gap in a semiconductor is:',
              options: ['Zero (bands overlap)', 'Very large (~10 eV)', 'Small (~1 eV)', 'Infinite'],
              correctIndex: 2,
              explanation: 'Semiconductors have a small energy gap (~1 eV) between the valence and conduction bands, unlike conductors (overlapping bands) and insulators (very large gap).',
            },
            {
              id: 'slo2',
              type: 'mcq',
              question: 'When a transistor is in the cutoff state, it acts as:',
              options: ['A closed switch', 'An open switch', 'An amplifier', 'A battery'],
              correctIndex: 1,
              explanation: 'In cutoff state, the base-emitter voltage is below 0.7V, so no collector current flows. The transistor acts as an open switch (OFF state).',
            },
            {
              id: 'slo3',
              type: 'mcq',
              question: 'Which type of impurity is added to create a p-type semiconductor?',
              options: ['Pentavalent (5 valence electrons)', 'Trivalent (3 valence electrons)', 'Tetravalent (4 valence electrons)', 'Monovalent (1 valence electron)'],
              correctIndex: 1,
              explanation: 'Trivalent impurities (like boron or aluminium with 3 valence electrons) are added to create p-type semiconductors, where holes are the majority charge carriers.',
            },
          ],
        },
      ],
