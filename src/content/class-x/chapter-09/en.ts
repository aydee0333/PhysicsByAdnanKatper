...
const chapter09En: ChapterContent = {
  ...
  objectives: [
    'Describe the Bohr model of the atom and explain energy levels',
    'Write and balance nuclear decay equations for alpha and beta decay',
    'Define activity and the becquerel; solve half-life problems',
    'Explain the construction and working of a nuclear reactor',
    'Describe the uses of radioactivity in medicine (radiotherapy, tracers) and industry',
    'Distinguish between nuclear fission and fusion and their energy implications',
  ],
  sections: [
    {
