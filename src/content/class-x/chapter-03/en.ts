...
const chapter03En: ChapterContent = {
  ...
  objectives: [
    'State and apply the laws of reflection of light',
    'Distinguish between regular and diffused reflection',
    'State Snell\'s law and solve problems involving refraction of light',
    'Explain total internal reflection and its applications in optical fibres',
    'Apply the lens formula (1/v - 1/u = 1/f) and magnification formula',
    'Describe the working of simple and compound microscopes, telescopes, and the human eye',
  ],
  sections: [
    {
      id: 'nature-of-light',
